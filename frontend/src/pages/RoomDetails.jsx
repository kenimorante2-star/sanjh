...
const RoomDetails = () => {
    ...
    // No longer tracking date-based booked days; status-only availability
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // NOTE: Do not block dates based on existing bookings; rely solely on
                // current physical room status (available/occupied/maintenance).
